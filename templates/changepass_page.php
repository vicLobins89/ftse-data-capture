...
<div id="password-reset-form" class="page_textbox">
	<div class="panel-grid-cell">
		<div class="textwidget">
			...
			<div class="page_form">
				<form name="resetpassform" id="signupform" action="<?php echo site_url( 'wp-login.php?action=resetpass' ); ?>" method="post" autocomplete="off">
					...
					<p class="description" style="text-align: left;">Hint: Please use a minimum of 7 characters and include at least 1 number in your password.</p>

					<p class="form-row">
						<input disabled type="submit" name="submit" id="resetpass-button" class="button register-button" value="<?php _e( 'Reset Password', 'ftse-data-capture' ); ?>">
					</p>
				</form>
			</div>
		</div>
